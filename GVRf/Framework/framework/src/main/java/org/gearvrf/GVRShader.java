...
public class GVRShader
{
    ...
    protected static String sTransformVkUBOCode =
            "#ifdef HAS_MULTIVIEW\n"
            + "   #define u_projection scene_matrices[0]\n"
            + "   #define u_view scene_matrices[gl_ViewID_OVR + uint(1)]\n"
            + "   #define u_view_i scene_matrices[gl_ViewID_OVR + uint(3)]\n"
            + "   #define u_mvp scene_matrices[u_matrix_offset + gl_ViewID_OVR + uint(1)]\n"
            + "#else\n"
            + "   #define u_projection scene_matrices[0]\n"
            + "   #define u_view scene_matrices[u_right + uint(1)]\n"
            + "   #define u_view_i scene_matrices[u_right + uint(3)]\n"
            + "   #define u_mvp scene_matrices[0]\n"
            + "#endif\n"
            + "#define u_model u_matrices[u_matrix_offset + uint(2)]\n"
            ...
            + "     float u_proj_offset;\n"
            + "}pushConsts;\n"
            + "layout (std140, set = 0, binding = 0) uniform scene_ubo {\n "
            + "     mat4 scene_matrices[20];\n"
            + "};\n"
            + "layout (std140, set = 1, binding = 0) uniform Transform_ubo {\n "
            + "     mat4 u_matrices[20];\n"
            + "};\n"
